...
namespace vkb
{
                                 ...
                                 VkImageSubresourceRange const& subresource_range)
    {
        ...
        image_layout_transition(command_buffer, image, src_stage_mask, dst_stage_mask, src_access_mask, dst_access_mask,
                                old_layout, new_layout, subresource_range);
    }
                                 ...
                                 VkImageLayout new_layout)
    {
        ...
        {
            image_memory_barriers.emplace_back(VkImageMemoryBarrier{
