...
#undef STR
    ...
    /*const std::string to_string(sg::AlphaMode mode)
    {
        ...
        if (mode == sg::AlphaMode::Mask)
        {
            return "Mask";
        }
        if (mode == sg::AlphaMode::Opaque)
        {
            return "Opaque";
        }
        return "Unkown";
