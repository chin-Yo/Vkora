...
namespace vkb
{
    ...
    inline bool validate_flags(const VkPhysicalDevice &gpu, const std::vector<VkDescriptorSetLayoutBinding> &bindings, const std::vector<VkDescriptorBindingFlagsEXT> &flags)
    {
                                                                                                ...
                                                                                                shader_modules{shader_modules}
    {
                         ...
                         { return shader_resource.mode == ShaderResourceMode::UpdateAfterBind; }) != resource_set.end())
        {
            ...
            binding_flags_create_info.bindingCount = (uint32_t)(binding_flags.size());
