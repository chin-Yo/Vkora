...
namespace vkb
{
    ...
    ComputePipeline::ComputePipeline(VulkanDevice& device,
                                     ...
                                     PipelineState& pipeline_state) : Pipeline{device}
    {
        ...
        const auto specialization_constant_state = pipeline_state.get_specialization_constant_state().
                                                                  get_specialization_constant_state();
                                       ...
                                       PipelineState& pipeline_state) : Pipeline{device}
    {
        ...
        for (const ShaderModule* shader_module : pipeline_state.get_pipeline_layout().get_shader_modules())
        {
            ...
            VkResult result = vkCreateShaderModule(device.GetHandle(), &vk_create_info, nullptr,
        ...
        vertex_input_state.vertexAttributeDescriptionCount = to_u32(
            pipeline_state.get_vertex_input_state().attributes.size());

        vertex_input_state.pVertexBindingDescriptions = pipeline_state.get_vertex_input_state().bindings.data();
        vertex_input_state.vertexBindingDescriptionCount = to_u32(
            pipeline_state.get_vertex_input_state().bindings.size());
        ...
        input_assembly_state.primitiveRestartEnable = pipeline_state.get_input_assembly_state().
        ...
        rasterization_state.rasterizerDiscardEnable = pipeline_state.get_rasterization_state().
        ...
        color_blend_state.pAttachments = reinterpret_cast<const VkPipelineColorBlendAttachmentState*>(pipeline_state.
            get_color_blend_state().attachments.data());
