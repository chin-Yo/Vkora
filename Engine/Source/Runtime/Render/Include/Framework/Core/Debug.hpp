...
namespace vkb
{
    ...
    public:
        ...
        void set_debug_name(VkDevice, VkObjectType, uint64_t, const char*) const override
        {
        }

        void set_debug_tag(VkDevice, VkObjectType, uint64_t,
                           uint64_t, const void*, size_t) const override
        {
        }

        void cmd_begin_label(VkCommandBuffer,
                             const char*, glm::vec4) const override
        {
        }

        void cmd_end_label(VkCommandBuffer) const override
        {
        }

        void cmd_insert_label(VkCommandBuffer,
                              const char*, glm::vec4) const override
        {
        }
    };
