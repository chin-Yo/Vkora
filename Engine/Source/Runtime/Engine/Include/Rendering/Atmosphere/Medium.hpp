...
{
    glm::vec3 scatterRayleigh  = { 5.802f, 13.558f, 33.1f };
    ...
    glm::vec3 absorbOzone       = { 0.65f, 1.881f, 0.085f };
    ...
    glm::vec3 getSigmaS(float h) const;

    glm::vec3 getSigmaT(float h) const;

    glm::vec3 evalPhaseFunction(float h, float u) const;
};