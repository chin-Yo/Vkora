...
layout(input_attachment_index = 2, binding = 2) uniform subpassInput i_normal;	// .xyz = normal[0,1], .w = roughness
layout(input_attachment_index = 3, binding = 3) uniform subpassInput i_material;// .r = metallic
