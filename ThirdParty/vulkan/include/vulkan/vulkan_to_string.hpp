...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string(StructureType value)
  {
    ...
    case StructureType::ePhysicalDevicePresentModeFifoLatestReadyFeaturesEXT:
      return "PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT";
#if defined(VK_USE_PLATFORM_FUCHSIA)
  ...
  VULKAN_HPP_INLINE std::string to_string(PresentModeKHR value)
  {
    ...
    case PresentModeKHR::eFifoLatestReadyEXT:
      return "FifoLatestReadyEXT";
    default:
      return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString(static_cast<uint32_t>(value)) + " )";
    }
  }
